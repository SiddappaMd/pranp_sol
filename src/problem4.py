...
def get_dataframe(file_name):
    ...
    dataframe['maximum_temp']=list(map(float,dataframe['maximum_temp'].values))
    dataframe['minimu_temp']=list(map(float,dataframe['minimu_temp'].values))
    dataframe['precipitation']=list(map(float,dataframe['precipitation'].values))
...
f.close()
print("Successfully generated the output for problem 2 in answers folder: In YCorrelations.out")
